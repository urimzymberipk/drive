...
<!--                  <Option-->
<!--                      v-if="isPdf && item.data.attributes.is_save_to_blockchain !== 1"-->
<!--                      @click.native="saveToBlockChain(item)"-->
<!--                      title="Save To BlockChain"-->
<!--                      icon="favourites"-->
<!--                  />-->


                  <SaveToBlockchainOption
                      v-if="isPdf && item.data.attributes.is_save_to_blockchain !== 1"
                      @click.native="saveToBlockChain(item)"
                  />
...
import SaveToBlockchainOption from "../../components/Icons/SaveToBlockchainOption";
