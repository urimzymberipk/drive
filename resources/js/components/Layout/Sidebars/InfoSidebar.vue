<template>
	...
	>
        ...
        <div v-if="isSingleFile && !isEmpty">
          ...
          <!--tx Link-->
          <ListInfoItem v-if="singleFile.data.attributes.is_save_to_blockchain" :title="'tx Link'">
            <a :href="singleFile.data.attributes.txLink" target="_blank">{{ singleFile.data.attributes.txLink }}</a>
          </ListInfoItem>

          <!--cerLink-->
          <ListInfoItem v-if="singleFile.data.attributes.is_save_to_blockchain" :title="'cer Link'">
            <a :href="singleFile.data.attributes.cerLink" target="_blank">{{ singleFile.data.attributes.cerLink }}</a>
          </ListInfoItem>

          <!--fileHash-->
          <ListInfoItem v-if="singleFile.data.attributes.is_save_to_blockchain" :title="'file Hash'" :content="singleFile.data.attributes.fileHash" />

          <!--access Token-->
          <ListInfoItem v-if="singleFile.data.attributes.is_save_to_blockchain" :title="'access Token'" :content="singleFile.data.attributes.accessToken" />
